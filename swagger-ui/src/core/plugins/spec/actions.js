...
export const execute = ( { path, method, ...extras }={} ) => (system) => {
  ...
  // Manuel Mora
  let api = extras.securities.authorized.api_key.value
  spec.basePath = spec.basePath.replace("{apiKey}", api)
  extras.securities.authorized = {}
  extras.securities.definitions = {}
